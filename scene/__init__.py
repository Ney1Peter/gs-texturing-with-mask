...
class Scene:
    ...
    def __init__(self, args : ModelParams, shuffle=True, resolution_scales=[1.0], num_pts=500_000):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            self.scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval, 8, "sfm", num_pts)
        ...
        if not self.loaded_iter:
            with open(self.scene_info.ply_path, 'rb') as src_file, open(os.path.join(args.model_path, "input.ply") , 'wb') as dest_file:
        ...
        # if self.loaded_iter:
        #     if args.save_old_format:
        #         self.gaussians.load_ply(os.path.join(self.model_path,
        #                                                    "point_cloud",
        #                                                    "iteration_" + str(self.loaded_iter),
        #                                                    "point_cloud.ply"))
        #     else:
        #         self.gaussians.load_ply_new(os.path.join(self.model_path,
        #                                                    "point_cloud",
        #                                                    "iteration_" + str(self.loaded_iter),
        #                                                    "point_cloud_new.ply"))
        # else:
        #     self.gaussians.create_from_pcd(self.scene_info.point_cloud, self.cameras_extent, generalised_kernel=generalised_kernel)
